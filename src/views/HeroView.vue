  ...
  <div class="min-h-screen flex flex-col bg-[#ecf3f4]">
    ...
    <main id="main-content" class="flex-1 flex flex-col items-center text-center px-4 py-16 sm:py-20 gap-6" role="main" aria-labelledby="hero-heading">
      ...
      <form class="flex w-full max-w-xl" role="search" aria-label="Search Bandcamp artist" @submit.prevent="handleSubmit">
        <div class="flex items-center flex-1 h-12 bg-white border-0 border-[#22222229] overflow-hidden focus:ring-0">
          <Search :size="15" class="shrink-0 ml-3 text-[#aaa]" aria-hidden="true" />
          <input
            v-model="artistInput"
            type="text"
            ...
            class="flex-1 min-w-0 h-full bg-transparent border-none outline-none focus-visible:outline-none text-sm text-[#222] placeholder:text-[#aaa] px-3"
